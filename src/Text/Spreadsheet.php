...
/**
 * Utility class for working with XLSX (Office Open XML Spreadsheet) files.
 * Provides methods for validating, outputting and serving XLSX files.
 *
 * @link https://www.iana.org/assignments/media-types/application/vnd.openxmlformats-officedocument.spreadsheetml.sheet IANA MIME type
...
class Spreadsheet
{
	...
	/**
	 * Checks if a file is a valid XLSX file based on extension and MIME type.
	 * @param string $filePath The path to the file to check
	 * @param string $clientOriginalName The original file name from client
	 * @return bool True if the file is a valid XLSX file, false otherwise
	 */
	...
	/**
	 * Outputs an XLSX file to the client browser.
	 * No output should be performed before or after calling this function.
	 * @param string $filePath The path to the XLSX file to output
	...
	/**
	 * Creates an HTTP response for an XLSX file.
