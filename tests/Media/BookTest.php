...
final class BookTest extends TestCase
{
	...
	{
		$this->assertTrue(Book::isValidIsbn('0-306-40615-2'));
		$this->assertTrue(Book::isValidIsbn('0306406152'));
		$this->assertTrue(Book::isValidIsbn('043942089X'));
	}

	public function testCheckIsbnWithValidIsbn13(): void
	{
		$this->assertTrue(Book::isValidIsbn('978-0-306-40615-7'));
		$this->assertTrue(Book::isValidIsbn('9780306406157'));
		$this->assertTrue(Book::isValidIsbn('978-3-16-148410-0'));
	}

	public function testCheckIsbnWithInvalidIsbn(): void
	{
		$this->assertFalse(Book::isValidIsbn('invalid'));
		$this->assertFalse(Book::isValidIsbn('123'));
		$this->assertFalse(Book::isValidIsbn('0000000000'));
		$this->assertFalse(Book::isValidIsbn('9780000000000'));
	}

	public function testCheckIsbnWithEmptyString(): void
	{
		$this->assertFalse(Book::isValidIsbn(''));
	}
	...
	{
		$this->assertTrue(Book::isValidIsbn10('0-306-40615-2'));
		$this->assertTrue(Book::isValidIsbn10('0306406152'));
		$this->assertTrue(Book::isValidIsbn10('0-684-84328-5'));
		$this->assertTrue(Book::isValidIsbn10('0684843285'));
	}

	public function testCheckIsbn10WithValidIsbn10WithX(): void
	{
		// ISBN-10 can have 'X' as the last check digit
		$this->assertTrue(Book::isValidIsbn10('043942089X'));
	}

	public function testCheckIsbn10WithInvalidIsbn10(): void
	{
		$this->assertFalse(Book::isValidIsbn10('invalid'));
		$this->assertFalse(Book::isValidIsbn10('123'));
		$this->assertFalse(Book::isValidIsbn10('0000000000'));
	}

	public function testCheckIsbn10WithIsbn13(): void
	{
		// Should reject ISBN-13 when checking for ISBN-10
		$this->assertFalse(Book::isValidIsbn10('978-2-207-03641-2'));
		$this->assertFalse(Book::isValidIsbn10('9782207036412'));
	}
	...
	{
		$this->assertTrue(Book::isValidIsbn13('978-0-306-40615-7'));
		$this->assertTrue(Book::isValidIsbn13('9780306406157'));
		$this->assertTrue(Book::isValidIsbn13('978-3-16-148410-0'));
		$this->assertTrue(Book::isValidIsbn13('9783161484100'));
	}

	public function testCheckIsbn13WithInvalidIsbn13(): void
	{
		$this->assertFalse(Book::isValidIsbn13('invalid'));
		$this->assertFalse(Book::isValidIsbn13('123'));
		$this->assertFalse(Book::isValidIsbn13('9780000000000'));
	}

	public function testCheckIsbn13WithIsbn10(): void
	{
		// Should reject ISBN-10 when checking for ISBN-13
		$this->assertFalse(Book::isValidIsbn13('2-2070-3641-5'));
		$this->assertFalse(Book::isValidIsbn13('2207036415'));
	}
	...
	{
		$this->assertTrue(Book::isValidIssn('0378-5955'));
		$this->assertTrue(Book::isValidIssn('03785955'));
		$this->assertTrue(Book::isValidIssn('0317-8471'));
		$this->assertTrue(Book::isValidIssn('03178471'));
	}

	public function testCheckIssnWithValidIssnWithX(): void
	{
		// ISSN can have 'X' as the last check digit
		$this->assertTrue(Book::isValidIssn('0003-004X'));
	}

	public function testCheckIssnWithInvalidIssn(): void
	{
		$this->assertFalse(Book::isValidIssn('invalid'));
		$this->assertFalse(Book::isValidIssn('123'));
		$this->assertFalse(Book::isValidIssn('00000000'));
		$this->assertFalse(Book::isValidIssn('0000-0000'));
	}

	public function testCheckIssnWithEmptyString(): void
	{
		$this->assertFalse(Book::isValidIssn(''));
	}
	...
	{
		$this->assertFalse(Book::isValidIsbn('0000000000'));
		$this->assertFalse(Book::isValidIsbn('1111111111'));
		$this->assertFalse(Book::isValidIsbn('9999999999999'));
	}

	public function testCheckIsbnRejectsSequentialDigits(): void
	{
		$this->assertFalse(Book::isValidIsbn('0123456789'));
		$this->assertFalse(Book::isValidIsbn('9876543210'));
		$this->assertFalse(Book::isValidIsbn('1234567890123'));
	}
