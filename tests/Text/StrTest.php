...
final class StrTest extends TestCase
{
	...
	{
		$word = Str::getRandomPronounceableWord(10);
	...
	{
		$str = Str::getRandomString(10, 'abc');
	...
	{
		$str = Str::getRandomAlphaString(10);
		$this->assertSame(10, strlen($str));
	...
	{
		$str = Str::getRandomAlphaString(10, uppercaseEnabled: true, lowercaseEnabled: false);
		$this->assertSame(10, strlen($str));
		$this->assertMatchesRegularExpression('/^[A-Z]+$/', $str);
	}
	...
	{
		$str = Str::getRandomNumericString(10);
		$this->assertSame(10, strlen($str));
	...
	{
		$str = Str::getRandomNumericString(10, startWith0: false);
		$this->assertSame(10, strlen($str));
	...
	{
		$str = Str::getRandomAlphanumericString(10);
		$this->assertSame(10, strlen($str));
